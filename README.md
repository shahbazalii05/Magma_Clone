...
Welcome to the **Magma_Clone** project! This site is built using **HTML**, **CSS**, and **JavaScript** to offer a sleek and user-friendly interface aimed at enhancing the user experience. Whether you're tracking your expenses or displaying financial information, this landing page is designed with usability and aesthetics in mind.
...
- **Canvas** for interactivity design.

## Desktop view
[Document.webm](https://github.com/user-attachments/assets/026b565d-a7ab-4ef3-a6bb-e651d07d0f12)
...
- **JS:** Used to structure the animation and Canvas of the page.
...
- git clone https://github.com/shahbazalii05/Magma_Clone.git
